...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, merge_tree_min_bytes_per_task_for_remote_reading, 4 * DBMS_DEFAULT_BUFFER_SIZE, "Min bytes per mark.", 0) \
    M(Bool, merge_tree_use_prewhere_columns_to_determine_task_size, false, "Some bullshit.", 0) \
    M(Bool, merge_tree_use_const_size_tasks, false, "Some bullshit.", 0) \
    \
